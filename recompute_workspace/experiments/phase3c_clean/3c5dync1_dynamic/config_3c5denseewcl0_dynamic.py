#!/usr/bin/env python3
"""Dense lycee + EWC baseline using the calibrated 3C5dync1 CL plumbing."""
...
class RunConfig(BaseRunConfig):
    exp_id: str = "3C5denseewcl0_lycee200_from_densec1best_softtransfer"
    results_dir: str = (
        "results/phase3/3c/3c5/"
        "3c5denseewcl0_lycee200_from_densec1best_softtransfer_noamp_dm256_l2_ff1024_spe16k"
    )
    ...
    num_workers: int = 2
    derived_cache_name: str = "3c5denseewcl0_lycee_scratchpad_v3"
    init_checkpoint: str = (
        "results/phase3/3c/3c5/"
...
def source_of_truth_summary() -> str:
    return (
        "run_config=3c5_dense_ewc_lycee_from_densec1best | "
