#!/usr/bin/env python3
"""Simple dense+EWC college baseline v1 using the calibrated 3C5dync1 CL plumbing."""
...
class RunConfig(BaseRunConfig):
    exp_id: str = "3C5denseewc1_college200_from_denseconv0best_fixedmix"
    results_dir: str = (
        "results/phase3/3c/3c5/"
        "3c5denseewc1_college200_from_denseconv0best_fixedmix_adamw_cosine_noamp_dm256_l2_ff1024_spe16k"
    )
    ...
    num_workers: int = 2
    derived_cache_name: str = "3c5denseewc1_college_scratchpad_v3"
    init_checkpoint: str = "results/bootstrap_checkpoints/3c5denseconv0/seed_42_primaire_best.pt"
...
def source_of_truth_summary() -> str:
    return (
        "run_config=3c5_dense_ewc_college_v1_from_denseconv0best | "
        "runtime_engine=clean_shared_with_fullparam_ewc | "
        "dataset=3c5_scratchpad_v3_primary_college_full11_module_bundles"
    )
