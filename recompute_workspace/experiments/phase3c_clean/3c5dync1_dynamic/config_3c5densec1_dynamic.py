#!/usr/bin/env python3
"""Simple dense college control baseline using the calibrated 3C5dync1 CL plumbing."""
...
class RunConfig(BaseRunConfig):
    exp_id: str = "3C5densec1_college200_from_denseconv0best_fixedmix"
    results_dir: str = (
    ...
    num_workers: int = 2
    derived_cache_name: str = "3c5densec1_college_scratchpad_v3"
...
def source_of_truth_summary() -> str:
    return (
        "run_config=3c5_dense_college_control_from_denseconv0best | "
