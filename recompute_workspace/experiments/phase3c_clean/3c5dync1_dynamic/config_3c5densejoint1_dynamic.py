#!/usr/bin/env python3
"""Dense joint-training extension over primaire+college+lycee from densejoint0 last."""
...
class RunConfig(BaseRunConfig):
    exp_id: str = "3C5densejoint1_full33_from_densejoint0last600"
    results_dir: str = (
        "results/phase3/3c/3c5/"
        "3c5densejoint1_full33_from_densejoint0last600_cosinefloor03_noamp_dm256_l2_ff1024_spe16k"
    )
    derived_cache_name: str = "3c5densejoint1_full33_scratchpad_v3"
    init_checkpoint: str = (
        "results/phase3/3c/3c5/"
    ...
    epochs_per_level: int = 600
    last_level_epochs: int = 600
...
def source_of_truth_summary() -> str:
    return (
        "run_config=3c5_dense_joint_full33_from_densejoint0last600 | "
