...
from curriculum import math_curriculum as math_curriculum_mod

# Current 3C5 scratchpad checkpoints use max_a_len=128. Keep converters
# conservative so JSONL scratchpad caches never rely on downstream truncation.
